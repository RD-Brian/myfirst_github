...
class ModelCustomerCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET name = '" . $this->db->escape($data['name']) . "', mobile = '" . $this->db->escape($data['mobile']) . "', birthday = '" . $this->db->escape($data['birthday']) . "', sex = '" . $this->db->escape($data['sex']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']['account']) ? json_encode($data['custom_field']['account']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
