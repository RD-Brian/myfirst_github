...
class ModelCustomerOrder extends Model {
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *,o.name AS name,os.name AS status FROM `" . DB_PREFIX . "order` o LEFT JOIN " . DB_PREFIX .  "order_status os ON(o.order_status_id = os.order_status_id) WHERE o.order_id = '" . (int)$order_id . "' AND o.customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0'");
