<?php
class ModelRoomFacility extends Model {
	...
	public function getFacilities($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "room_facility rf LEFT JOIN " . DB_PREFIX . "room_facility_description rfd ON (rf.room_facility_id = rfd.room_facility_id) WHERE rfd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		...
		$sql .= " GROUP BY rfd.room_facility_id";
